	...
	switch ($format) {
		...
		default:
			throw new \RuntimeException(
				sprintf(
					"Unknown markdown format '%s'. Only 'github' or 'bitbucket' allowed.
					Check your .phpdoc-md config file", $format));
	}
	return $parser;
...
/**
 * Get all declared classes within a specific namespace.
 *
 * This function retrieves all classes currently declared in the script
 * and filters them to return only those that belong to the specified namespace.
 *
 * @param string $namespace The namespace to filter classes by.
 * @return array An array of fully qualified class names within the specified namespace.
 */
